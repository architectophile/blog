...
그래서 해결 방법을 찾아보니 윈도우즈10의 소리 설정에서 제공하는 ***'라우드니스 이퀄라이제이션(loudness equalization)'*** 기능을 발견하였다. 이 기능은 이름 그대로 매우 시끄러운 소리를 다른 소리들과 동등하게 만들어 준다. 따라서 시청하던 영상의 ***소리가 갑자기 커져도 자동으로 소리를 낮춰 평균적인 볼륨으로 조절해준다***는 것이다.
